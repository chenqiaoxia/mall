...
import { Icon,Cascader,Checkbox } from 'antd';
var address=[
			...
			<div className="filter">
               <div className="f-line">
                  <div className="f-sort">
                    <a>
                      综合<Icon type="arrow-down" />
                    </a>
                    <a>
                      销量<Icon type="arrow-down" />
                    </a>
                    <a>
                      评论数<Icon type="arrow-down" />
                    </a>
                    <a>
                      新品<Icon type="arrow-down" />
                    </a>
                     <a>
                      价格<span className="f-sort-span"><Icon type="caret-up" style={{fontSize:5,height:6}}/><Icon type="caret-down" style={{fontSize:5,height:6}}/></span>
                    </a>
                  </div>
                  <div className="f-datagrid">
                     <a className="fdg-item">
                         <span className="def-bar" style={{height:"16%"}}></span>
                     </a>
                     <a className="fdg-item">
                         <span className="def-bar" style={{height:"57%"}}></span>
                     </a>
                     <a className="fdg-item">
                         <span className="def-bar" style={{height:"85%"}}></span>
                     </a>
                     <a className="fdg-item">
                         <span className="def-bar" style={{height:"30%"}}></span>
                     </a>
                     <a className="fdg-item">
                        <span className="def-bar" style={{height:"10%"}}></span>
                     </a>
                  </div>
                  <div className="f-price-set">
                      <input value="¥" style={{color:"rgb(204, 204, 204)"}}/>
                      <span>-</span>
                      <input value="¥" style={{color:"rgb(204, 204, 204)"}}/>
                  </div>
               </div>
               <div className="f-line">
                  <span>配送至:</span>
                  <div className="f-line-addr">
                      <Cascader options={address} placeholder="请选择地址" />
                  </div>
                  <div className="f-feature">
                      <Checkbox>京东配送</Checkbox>
                      <Checkbox>货到付款</Checkbox>
                      <Checkbox>仅显示有货</Checkbox>
                      <Checkbox>可配送全球</Checkbox>
